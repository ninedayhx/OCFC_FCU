...
UART_ReceiveTypeDef uart1_receive = {{0}, 0, false};
UART_ReceiveTypeDef uart2_receive = {{0}, 0, false};
UART_ReceiveTypeDef uart3_receive = {{0}, 0, false};
...
void MX_USART3_UART_Init(void)
{
  ...
  HAL_UART_Receive_DMA(&huart3, uart3_receive.rx_buffer, UART3_RX_BUFFER_SIZE); // 启动 DMA 接收
